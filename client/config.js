...
const CHANGELOG = [
    "Diep Competitive Patch",
    "",
    "Enter Username|Password into any server",
    "It will tell you which server to join, or you will automatically join",
    "",
    "If you don't have an acount you can contact me on discord", 
    "and I can add your account",
    "", 
    "Entering any server as 'Spectator' will allow you to spectate", 
    "even if you don't have a registered acount"
];
