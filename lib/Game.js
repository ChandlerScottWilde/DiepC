...
const CompLobby_1 = __importDefault(require("./Gamemodes/CompLobby"));
const Lobby_1 = require("./comp_addons/Lobby");
...
const GamemodeToArenaClass = {
    ...
    "ball": Ball_1.default,
    "comp": CompLobby_1.default
};
class GameServer {
    constructor(gamemode, name, endpoint) {
    ...
    verifiedPlayerCount() {
        ...
        for (const client of this.clients) {
            if (client.verifiedUser == true && Entity_1.Entity.exists(client.camera?.cameraData.values.player))
                count++;
        }
        return count;
    }
