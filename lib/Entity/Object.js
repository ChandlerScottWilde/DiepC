    ...
    applyPhysics() {
        ...
        if (!(this.physicsData.values.flags & 256)) {
            ...
            yPos: {
                ...
                else if (this.positionData.values.y > arena.arenaData.values.bottomY - adjust + arena.ARENA_PADDING)
                    this.positionData.y = arena.arenaData.values.bottomY - adjust + arena.ARENA_PADDING;
                else
                    break yPos;
