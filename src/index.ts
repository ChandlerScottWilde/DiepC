...
import { registerGame } from "./comp_addons/GameManager";
...
app.listen(PORT, (success) => {
    ...
    const lobby1 = new GameServer("comp", "1", "comp1");
    const lobby4 = new GameServer("sandbox", "4", "sandbox");
    ...
    for (const game of games) console.log("> " + `localhost:${config.serverPort}/${game.endpoint}`.padEnd(40, " ") + " -> " + game.name);
});
