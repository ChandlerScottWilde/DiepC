...
export default class TankBody extends LivingEntity implements BarrelBase {
    ...
    public reloadTime = 15; // defualt 15 \
   ...
   public onDeath(killer: LivingEntity) {
    ...
    public tick(tick: number) {
        ...
        } //TODO:: FIX PREDATOR else if (this.cameraEntity.cameraData.values.flags & CameraFlags.usesCameraCoords) this.cameraEntity.cameraData.flags ^= CameraFlags.usesCameraCoords;
        ...
        /* I control flashing manually in lobby
